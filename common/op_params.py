...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {'camera_offset': Param(0.06, VT.number, 'Your camera offset to use in lane_planner.py', live=True),
                        'indi_inner_gain': Param(15.0, VT.number, live=True),
                        'indi_outer_gain': Param(14.99, VT.number, live=True),
                        'indi_time_constant': Param(5.5, VT.number, live=True),
                        'indi_actuator_effectiveness': Param(15.0, VT.number, live=True),
                        ...
                        'corolla_use_indi': Param(False, bool), 'birdmantuning for corolla tss2, recommended set enable unsafe steering rate to true and flash panda'
                        ...
                        'indi_inner_gain_bp': Param([0.0], [list, float, int], live=True, depends_on=INDI_SHOW_BREAKPOINTS),
                        'indi_inner_gain_v': Param([15.0], [list, float, int], live=True, depends_on=INDI_SHOW_BREAKPOINTS),
                        'indi_outer_gain_bp': Param([20, 21, 25 ,26], [list, float, int], live=True, depends_on=INDI_SHOW_BREAKPOINTS),
                        'indi_outer_gain_v': Param([5.0, 9.0, 9.0, 14.99], [list, float, int], live=True, depends_on=INDI_SHOW_BREAKPOINTS),
                        'indi_time_constant_bp': Param([0.0], [list, float, int], live=True, depends_on=INDI_SHOW_BREAKPOINTS),
                        'indi_time_constant_v': Param([5.5], [list, float, int], live=True, depends_on=INDI_SHOW_BREAKPOINTS),
                        'indi_actuator_effectiveness_bp': Param([0.0], [list, float, int], live=True, depends_on=INDI_SHOW_BREAKPOINTS),
                        'indi_actuator_effectiveness_v': Param([15.0], [list, float, int], live=True, depends_on=INDI_SHOW_BREAKPOINTS),
