...
class MapD():
  ...
  def update_route(self, sm):
    ...
    self._lock.acquire()
    try:
      if self.way_collection is None or self.location_rad is None or self.bearing is None:
        return
      ...
      if self.route is None or self.route.way_collection_id != self.way_collection.id:
        self.route = self.way_collection.get_route(self.location_rad, self.bearing)
      ...
      self.route.update(self.location_rad, self.bearing)
