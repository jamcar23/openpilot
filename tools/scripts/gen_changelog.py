...
def export_semver_number(exp_next):
  ...
  print(get_next_semantic_version_number(last_entry, op_version) if exp_next else last_entry.fp_version)
...
if __name__ == '__main__':
  args = sys.argv[1:]
  export_nxt = '--export-next' in args

  if '--export' in args or export_nxt:
    export_semver_number(export_nxt)
  else:
    main()
